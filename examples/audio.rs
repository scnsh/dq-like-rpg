...
fn prepare_audio_and_ui(
    ...
    let loop_handle = asset_server.load("sounds/bgm/bgm_maoudamashii_8bit01.mp3");
    let sound_handle = asset_server.load("sounds/se/se_maoudamashii_retro03.mp3");
...
fn set_up_ui(
    ...
    let font = asset_server.load("fonts/PixelMplus12-Regular.ttf");
